...
const modifierPool: ModifierPool = {
  ...
  [ModifierTier.ULTRA]: [
    ...
    new WeightedModifierType(modifierTypes.VOUCHER, (party: Pokemon[], rerollCount: integer) => !party[0].scene.gameMode.isDaily ? Math.max(3 - rerollCount, 0) : 0, 6), // prev 3 | double voucher chance 
  ].map(m => {
