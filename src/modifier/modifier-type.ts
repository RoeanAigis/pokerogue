...
const modifierPool: ModifierPool = {
  ...
  [ModifierTier.GREAT]: [
    ...
    new WeightedModifierType(modifierTypes.VOUCHER, (party: Pokemon[], rerollCount: integer) => !party[0].scene.gameMode.isDaily ? Math.max(3 - rerollCount, 0) : 0, 6), // GREAT TIER +1 VOUCHER, double odds prev: 3
  ].map(m => {
  ...
  [ModifierTier.ULTRA]: [
    ...
    //new WeightedModifierType(modifierTypes.VOUCHER, (party: Pokemon[], rerollCount: integer) => !party[0].scene.gameMode.isDaily ? Math.max(3 - rerollCount, 0) : 0, 3), // relocated to great
  ].map(m => {
  ...
  [ModifierTier.ROGUE]: [
    ...
    new WeightedModifierType(modifierTypes.FORM_CHANGE_ITEM, 20), // prev: 18 | mega,dynamax,form change
    ...
    new WeightedModifierType(modifierTypes.VOUCHER_PLUS, (party: Pokemon[], rerollCount: integer) => !party[0].scene.gameMode.isDaily ? Math.max(9 - rerollCount * 3, 0) : 0, 9), // ULTRA TIER VOUCHER +5
  ].map(m => {
  ...
  [ModifierTier.MASTER]: [
    ...
    //new WeightedModifierType(modifierTypes.VOUCHER_PLUS, (party: Pokemon[], rerollCount: integer) => !party[0].scene.gameMode.isDaily ? Math.max(9 - rerollCount * 3, 0) : 0, 9), // RELOCATED TO ULTRA
